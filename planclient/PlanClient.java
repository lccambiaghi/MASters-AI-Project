...
public class PlanClient {
	...
	public PlanClient(BufferedReader serverMessages) throws Exception {
	...
	public LinkedList<Node> Plan() throws IOException {
		//System.err.format("Search starting with strategy %s.\n", strategy.toString());
		//strategy.addToFrontier(this.initialState);
		
		// create plan from initial state
		// create planner
		// planner.plan(plan)
	...
	public static void main(String[] args) throws Exception {
		...
		System.err.println("PlanClient initializing. I am sending this using the error output stream.");

		// Read level and create the initial state of the problem
		PlanClient client = new PlanClient(serverMessages);
		...
		try {
			...
			solution = client.Plan(client.initialState);
